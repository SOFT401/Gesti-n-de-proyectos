...
// theme switcher
    ...
    var setColor = function (color) {
    	var hr=$('#style_color').attr("href");
        $('#style_color').attr("href", hr.slice(0,hr.indexOf("css/"))+"css/style-" + color + ".css");
    }
...
// widget tools
    ...
    jQuery('.widget .tools .icon-plus').click(function () {
        jQuery(this).parents(".widget").find('.widget-form').slideDown();
    });
//    tool tips
